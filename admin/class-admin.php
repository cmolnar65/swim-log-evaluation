...
final class Admin {
	...
	public function upload() {
		...
		<?php foreach($pending as $p):
			...
			<p><strong><?php echo esc_html(sprintf(__('Uploaded source: %s','swim-log-evaluation'),strtoupper($row->source_type))); ?></strong> <?php echo esc_html(sprintf(__('Preserved for review on %s.','swim-log-evaluation'),wp_date('F j, Y g:i a',(new \DateTimeImmutable($row->imported_at,wp_timezone()))->getTimestamp(),wp_timezone()))); ?></p>
