...
final class Activator {
	...
	public static function activate() {
		...
		if ( ! Database::install_schema() ) {
			...
			wp_die(
				esc_html__( "Chris's Swim Training Progress and Evaluation could not create or verify all required database tables. No existing swim history was deleted.", 'chriss-swim-training-progress-evaluation' ),
				esc_html__( 'Plugin activation failed', 'chriss-swim-training-progress-evaluation' ),
